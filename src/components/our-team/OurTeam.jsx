...
const Team = () => {
    ...
    return teamData
      ...
      .map((member) => (
        ...
        >
          ...
          >
            <h3 className="text-[#d37c26] font-bold body-medium-bold">
              {member.name}
            </h3>
            <p className="text-gray text-md font-[400] text-regular">
              {member.role}
            </p>
          </div>
        </div>
  ...
  return (
    <div className={`py-16 md:py-[90px] h-auto w-full`}>
      <div className="mx-auto max-w-7xl items-center justify-between px-8 flex flex-col bg-[#242424]">
        <div className="text-center mb-12 md:mb-[60px]">
          <h2 className=" text-[40px] font-bold text-[#d37c26] mb-3">
            Ekibimiz
          </h2>
          <p
            className={`text-[#dadada] max-w-3xl mx-auto text-body-sm-regular sm:text-body-md-regular`}
          >
        ...
        >
          <div className="flex gap-4 flex-wrap items-center justify-center">
            <a
              onClick={() => setActiveButton(1)} className={`${activeButton === 1 ? style.active : ""} ${style.buttonHover} px-[28px] py-[12px] rounded-[50px] primary-color hover:text-white hover:bg-[#d37c26] border-solid border-[1px] cursor-pointer transition-all text-body-sm-regular sm:text-body-md-regular`}>
              Yönetim Kurulu
            </a>
            <a onClick={() => setActiveButton(2)} className={`${activeButton === 2 ? style.active : ""} ${style.buttonHover} px-[28px] py-[12px] rounded-[50px] primary-color hover:text-white hover:bg-[#d37c26] border-solid border cursor-pointer transition-all text-body-sm-regular sm:text-body-md-regular`}>
              Departman Başkanları
            </a>
            <a onClick={() => setActiveButton(3)} className={`${activeButton === 3 ? style.active : ""} ${style.buttonHover} px-[28px] py-[12px] rounded-[50px] primary-color hover:text-white hover:bg-[#d37c26] border-solid border-[1px] cursor-pointer transition-all text-body-sm-regular sm:text-body-md-regular`}>
              Genel Ekip Üyeleri
            </a>
          </div>
        </div>
